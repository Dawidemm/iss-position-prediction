...
def make_dataset(type: str, duration: int):
    MakeDataset(type=type, duration=duration).save_as_csv()

if __name__ == '__main__':
    make_dataset(type='new_train', duration=70)
    make_dataset(type='new_val', duration=20)
    make_dataset(type='new_test', duration=10)